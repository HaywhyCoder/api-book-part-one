...
# using a test date of 4/1/2024 to test min_last_changed_date
...
def test_get_all_performances(db_session):
    """Tests that the count of performances in the database is what is expected - all the performaces"""
...
def test_get_new_performances(db_session):
    """Tests that the count of performance in the database is what is expected"""
