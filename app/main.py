...
@app.get(
        ...
        description="If you have an SWC Player ID of a player from another API call such as v0_get_players, you can call this API",
...
@app.get(
        ...
        description="""Use this endpoint to get lists of SWC fantasy football leagues. You use the skip and limit to perform pagination of the API. League name is not guaranteed to be unique. Don't use the League ID for counting or logic, because that is an internal ID and is not guaranteed to be sequential""",
